...
public class AccountHeadService {
    ...
    public int insertAccountHead(JSONObject obj, HttpServletRequest request) throws Exception{
        ...
        try{
            ...
            logService.insertLog(BusinessConstants.LOG_MODULE_FINANCIAL_BILL,
    ...
    public int batchDeleteAccountHeadByIds(String ids)throws Exception {
        ...
        for(AccountHead accountHead: list){
            ...
            if(BusinessConstants.TYPE_ADVANCE_IN.equals(accountHead.getType())){
                if (accountHead.getOrganId() != null) {
                    // Mettre à jour le prépaiement du membre
        ...
        logService.insertLog(BusinessConstants.LOG_MODULE_FINANCIAL_BILL, sb.toString(),
    ...
    public int batchSetStatus(String status, String accountHeadIds)throws Exception {
        ...
        if(!ahIds.isEmpty()) {
            ...
            if(!noList.isEmpty() && ("0".equals(status) || "1".equals(status))) {
                String statusStr = status.equals("1")?BusinessConstants.LOG_STATUS_AUDITED:BusinessConstants.LOG_STATUS_UNAUDITED;
                logService.insertLog(BusinessConstants.LOG_MODULE_FINANCIAL_BILL,
    ...
    public void addAccountHeadAndDetail(String beanJson, String rows, HttpServletRequest request) throws Exception {
        ...
        // Vérifier si le compte de paiement est dupliqué avec les comptes dans les détails (document de transfert)
        ...
        if(list!=null) {
            ...
            /** Traiter les informations de la table secondaire du document */
        ...
        String statusStr = accountHead.getStatus().equals("1")?BusinessConstants.LOG_STATUS_AUDITED:"";
        logService.insertLog(BusinessConstants.LOG_MODULE_FINANCIAL_BILL,
