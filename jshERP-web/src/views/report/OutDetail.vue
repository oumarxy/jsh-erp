            ...
            <a-row :gutter="24">
              <a-col :md="6" :sm="24">
                <a-form-item label="Informations sur le produit" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-input placeholder="Veuillez saisir le code-barres, le nom, le code mnémonique, les spécifications, le modèle, etc." v-model="queryParam.materialParam"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
              ...
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="Unité de correspondance" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="Veuillez sélectionner l'unité de correspondance" v-model="queryParam.organId"
                ...
                <a-col :md="6" :sm="24" v-if="orgaTree.length">
                  <a-form-item label="Organisation" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-tree-select style="width:100%" allow-clear :treeData="orgaTree"
                                   v-model="queryParam.organizationId" placeholder="Veuillez sélectionner l'organisation">
                    </a-tree-select>
                  </a-form-item>
                </a-col>
                <a-col :md="6" :sm="24">
                  <a-form-item label="Catégorie de produit" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-tree-select style="width:100%" :dropdownStyle="{maxHeight:'200px',overflow:'auto'}" allow-clear
                                   :treeData="categoryTree" v-model="queryParam.categoryId" placeholder="Veuillez sélectionner la catégorie de produit">
                    </a-tree-select>
                  </a-form-item>
                </a-col>
                <a-col :md="6" :sm="24">
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        defColumns: [
          ...
          {
            title: 'Numéro de document', dataIndex: 'number', width: 100,
          ...
          {title: 'Date de sortie', dataIndex: 'operTime', width: 70},
    ...
    methods: {
      ...
      exportExcel() {
        let list = []
        let head = 'Numéro de document,Code-barres,Nom,Spécifications,Modèle,Couleur,Marque,Fabricant,Unité,Multi-attributs,Quantité,Prix unitaire,Montant,Taux de taxe (%),Montant de la taxe,Unité de correspondance,Entrepôt,Date de sortie,Remarque'
        ...
        this.handleExportXlsPost('Détails de sortie', 'Détails de sortie', head, tip, list)
      }
    }
  }
</script>
