...
<!-- Modifié à partir d'InDetail -->
<template>
  <a-row :gutter="24">
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        <!-- Zone de recherche
        projectId Entrepôt de sortie
        projectIdto Entrepôt de réception
        -->
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            ...
            <template v-if="toggleSearchStatus">
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="Entrepôt de sortie" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="Entrepôt de réception" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select
                      optionFilterProp="children"
                      :dropdownMatchSelectWidth="false"
                      showSearch
...
export default {
  ...
  data() {
    return {
      ...
      defColumns: [
        ...
        { title: 'Unité', dataIndex: 'mUnit', width: 60, ellipsis: true },
        ...
        { title: 'Entrepôt de sortie', dataIndex: 'dname', width: 80 },
        { title: 'Entrepôt de réception', dataIndex: 'sname', width: 80 },
        { title: 'Date de transfert', dataIndex: 'operTime', width: 80 },
  ...
  methods: {
    ...
    exportExcel() {
      let list = []
      let head =
        'Numéro de document,Code-barres,Nom,Spécifications,Modèle,Couleur,Marque,Fabricant,Unité,Quantité,Prix unitaire,Montant,Entrepôt de sortie,Entrepôt de réception,Date de transfert,Remarque'
      ...
      this.handleExportXlsPost('Détails de transfert', 'Détails de transfert', head, tip, list)
    },
  },
}
</script>
