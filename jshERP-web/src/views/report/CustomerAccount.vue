            ...
            <a-row :gutter="24">
              <a-col :md="6" :sm="24">
                <a-form-item label="Client" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select placeholder="Veuillez sélectionner le client" v-model="queryParam.organId"
                    :dropdownMatchSelectWidth="false" showSearch allow-clear optionFilterProp="children" @search="handleSearchCustomer">
                    <div slot="dropdownRender" slot-scope="menu">
                      <v-nodes :vnodes="menu" />
                      <a-divider style="margin: 4px 0;" />
                      <div class="dropdown-btn" @mousedown="e => e.preventDefault()" @click="initCustomer"><a-icon type="reload" /> Actualiser la liste</div>
                    </div>
        ...
        <section ref="print" id="reportPrint">
          <a-table
                        ...
                        <template>
                          <a-col :span="6">
                            ...
                            <a-checkbox :value="item.dataIndex" v-if="item.dataIndex!=='rowIndex'">
                              ...
                              <j-ellipsis value="Créances en fin de période" v-if="item.dataIndex==='allNeed'" :length="10"></j-ellipsis>
                            </a-checkbox>
                          </a-col>
                        </template>
                      </template>
            ...
            <span slot="allNeedTitle">
              Créances en fin de période
              <a-tooltip title="Créances en fin de période = Créances en début de période + Dettes de la période - Recouvrements de la période">
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        defColumns: [
          ...
          {title: 'Client', dataIndex: 'supplier', width: 150, ellipsis:true},
          ...
          {title: 'Créances en début de période', dataIndex: 'preNeed', sorter: (a, b) => a.preNeed - b.preNeed, width: 80},
          {title: 'Dettes de la période', dataIndex: 'debtMoney', sorter: (a, b) => a.debtMoney - b.debtMoney, width: 80},
          {title: 'Recouvrements de la période', dataIndex: 'backMoney', sorter: (a, b) => a.backMoney - b.backMoney, width: 80},
    ...
    methods: {
      ...
      loadData(arg) {
        ...
        getAction(this.url.list, params).then((res) => {
          if (res.code===200) {
            ...
            this.firstTotal = 'Créances en début de période : ' + res.data.firstMoney + "，"
            this.lastTotal = 'Créances en fin de période : ' + res.data.lastMoney
      ...
      exportExcel() {
        let list = []
        let head = 'Client,Contact,Numéro de téléphone portable,Numéro de téléphone,Adresse e-mail,Créances en début de période,Dettes de la période,Recouvrements de la période,Créances en fin de période'
        ...
        this.handleExportXlsPost('Réconciliation client', 'Réconciliation client', head, tip, list)
      },
