        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item>
                  <span>Montant de vente au détail réel : {{ realityPriceTotal }}</span>
                </a-form-item>
              </a-col>
            </a-row>
  ...
  data() {
    return {
      ...
      defColumns: [
        ...
        { title: 'Quantité de vente au détail', dataIndex: 'outSum', sorter: (a, b) => a.outSum - b.outSum, width: 80 },
        {
          title: 'Montant de vente au détail',
          dataIndex: 'outSumPrice',
          sorter: (a, b) => a.outSumPrice - b.outSumPrice,
          width: 80,
        },
        { title: 'Quantité de retour', dataIndex: 'inSum', sorter: (a, b) => a.inSum - b.inSum, width: 80 },
        {
          title: 'Montant de retour',
          dataIndex: 'inSumPrice',
          sorter: (a, b) => a.inSumPrice - b.inSumPrice,
          width: 80,
        },
        {
          title: 'Montant de vente au détail réel',
  ...
  methods: {
    ...
    exportExcel() {
      ...
      let head =
        ...
        mpStr +
        ',Unité,Quantité de vente au détail,Montant de vente au détail,Quantité de retour,Montant de retour,Montant de vente au détail réel'
      ...
      this.handleExportXlsPost('Statistiques de vente au détail', 'Statistiques de vente au détail', head, tip, list)
    },
  },
}
</script>
