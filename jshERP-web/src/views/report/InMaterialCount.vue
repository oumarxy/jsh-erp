          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item>
                  <span
                    >Quantité totale d'entrée : {{ numSumTotalStr }}，Montant total d'entrée :
...
export default {
  ...
  data() {
    return {
      ...
      defColumns: [
        ...
        { title: "Quantité d'entrée", dataIndex: 'numSum', sorter: (a, b) => a.numSum - b.numSum, width: 120 },
        { title: "Montant d'entrée", dataIndex: 'priceSum', sorter: (a, b) => a.priceSum - b.priceSum, width: 120 },
      ],
      url: {
  ...
  methods: {
    ...
    exportExcel() {
      let list = []
      let head =
        "Code-barres,Nom,Spécifications,Modèle,Couleur,Marque,Fabricant,Catégorie,Unité,Quantité d'entrée,Montant d'entrée"
      ...
      this.handleExportXlsPost("Résumé d'entrée", "Résumé d'entrée", head, tip, list)
    },
  },
}
</script>
