              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="Type" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select v-model="queryParam.type" placeholder="Veuillez sélectionner le type">
                    ...
                    <a-select-option value="财务员">Personnel financier</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: 'Nom', align: 'left', dataIndex: 'name', width: 200 },
        { title: 'Type', align: 'left', dataIndex: 'type', width: 150 },
