      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form" id="vendorModal">
          ...
          <a-row class="form-row" :gutter="24">
            ...
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Dette initiale">
                <a-input placeholder="Veuillez saisir la dette initiale" v-decorator.trim="['beginNeedPay']" />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Dette finale">
