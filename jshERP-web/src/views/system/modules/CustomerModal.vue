      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form" id="customerModal">
          ...
          <a-row class="form-row" :gutter="24">
            ...
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Fax">
                <a-input placeholder="Veuillez saisir le fax" v-decorator.trim="['fax']" />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Créances initiales">
                <a-input placeholder="Veuillez saisir les créances initiales" v-decorator.trim="['beginNeedGet']" />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Créances finales">
                <a-input v-decorator.trim="['allNeedGet']" :readOnly="true" />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Numéro d'identification fiscale">
                <a-input
                  placeholder="Veuillez saisir le numéro d'identification fiscale"
                  v-decorator.trim="['taxNum']"
                />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Taux de taxe (%)">
                <a-input-number
                  style="width: 100%"
                  placeholder="Veuillez saisir le taux de taxe"
                  v-decorator.trim="['taxRate']"
                />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Banque">
                <a-input placeholder="Veuillez saisir la banque" v-decorator.trim="['bankName']" />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Numéro de compte">
                <a-input placeholder="Veuillez saisir le numéro de compte" v-decorator.trim="['accountNumber']" />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Adresse">
                <a-input placeholder="Veuillez saisir l'adresse" v-decorator.trim="['address']" />
              </a-form-item>
            </a-col>
            <a-col :span="24 / 2">
