<template>
  ...
  >
    <a-tabs>
      <a-tab-pane tab="Icônes directionnelles" key="1">
        <ul>
      ...
      <a-tab-pane tab="Icônes indicatives" key="2">
        <ul>
      ...
      <a-tab-pane tab="Icônes d'édition" key="3">
        <ul>
      ...
      <a-tab-pane tab="Icônes de données" key="4">
        <ul>
      ...
      <a-tab-pane tab="Icônes web communes" key="5">
        <ul>
      ...
      <a-tab-pane tab="Marques et logos" key="6">
        <ul>
...
export default {
  ...
  methods: {
    ...
    chooseIcon (icon) {
      ...
      this.$message.success(`Sélectionné ${icon}`)
    },
    ok () {
      if (this.choosedIcon === '') {
        this.$message.warning("Aucune icône n'a été sélectionnée")
        return
      }
      this.reset()
