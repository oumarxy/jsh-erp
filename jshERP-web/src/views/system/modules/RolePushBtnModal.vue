              ...
              <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
                <a-col :md="12" :sm="24">
                  <a-button @click="toggleChecked">
                    {{ !checked ? 'Tout sélectionner' : 'Tout désélectionner' }}
                  </a-button>
                  <a-button @click="editToggleChecked" style="margin-left: 8px">
                    {{ !editChecked ? 'Tout sélectionner - Édition' : 'Tout désélectionner - Édition' }}
                  </a-button>
                  <a-button @click="auditToggleChecked" style="margin-left: 8px">
                    {{ !auditChecked ? 'Tout sélectionner - Audit' : 'Tout désélectionner - Audit' }}
                  </a-button>
                  <a-button @click="unAuditToggleChecked" style="margin-left: 8px">
                    {{ !unAuditChecked ? 'Tout sélectionner - Désaudit' : 'Tout désélectionner - Désaudit' }}
                  </a-button>
                  <a-button @click="exportToggleChecked" style="margin-left: 8px">
                    {{ !exportChecked ? 'Tout sélectionner - Export' : 'Tout désélectionner - Export' }}
                  </a-button>
                </a-col>
              </span>
            </a-row>
...
export default {
  ...
  methods: {
    ...
    /**
     * Conversion de format, contrôle l'affichage ou le masquage des boutons
     * @param param
     * @param btnStr
     * @param type
     * @returns {string}
