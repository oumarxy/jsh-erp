      ...
      <a-spin :spinning="confirmLoading">
        <div class="drawer-bootom-button">
          <a-dropdown :trigger="['click']" placement="topCenter">
            <a-menu slot="overlay">
              <a-menu-item key="1" @click="switchCheckStrictly(1)">Association parent-enfant</a-menu-item>
  ...
  methods: {
    ...
    loadTree(id) {
      ...
      getAction('/function/findRoleFunction?UBType=RoleFunctions&UBKeyId=' + id).then((res) => {
        if (res) {
          // Après avoir tout sélectionné dans l'organisation, puis ajouté une organisation, le nombre de sélections augmente
          this.allTreeKeys = []
