    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-page-search-wrapper">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="Membre payeur" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select placeholder="Veuillez sélectionner le membre payeur" showSearch allow-clear optionFilterProp="children" v-model="queryParam.organId" @search="handleSearchRetail">
                    <div slot="dropdownRender" slot-scope="menu">
                      <v-nodes :vnodes="menu" />
                      <a-divider style="margin: 4px 0;" />
                      <div class="dropdown-btn" @mousedown="e => e.preventDefault()" @click="initRetail(0)"><a-icon type="reload" /> Actualiser la liste</div>
                    </div>
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" title="Pour le module membres, collecte des prépaiements auprès des membres." slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '收预付款', prefixNo)">Voir</a>
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: 'Membre payeur', dataIndex: 'organName',width:140, ellipsis:true},
          ...
          { title: 'Montant de recouvrement', dataIndex: 'changeAmount',width:80},
