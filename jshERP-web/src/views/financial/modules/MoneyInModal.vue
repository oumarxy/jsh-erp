      ...
      <a-form :form="form">
        ...
        >
          <template #buttonBefore>
            <a-row :gutter="24" style="float: left; padding-bottom: 8px">
              ...
              <a-col :md="12" :sm="24" style="padding-left: 0">
                <a-button type="primary" icon="plus" @click="selectBeginNeed('客户')"
          ...
          <template #buttonAfter>
            <a-row :gutter="24" style="float: left; padding-bottom: 8px">
              <a-col :md="12" :sm="24">
                <a-button icon="link" @click="handleWaitNeed('客户')">En attente de recouvrement</a-button>
              </a-col>
            </a-row>
          </template>
        </j-editable-table>
        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Recouvrement réel">
              <a-input
                placeholder="Veuillez saisir le recouvrement réel"
  ...
  data() {
    return {
      ...
      accountTable: {
        ...
        columns: [
          {
            title: 'Numéro de document de vente',
            key: 'billNumber',
            width: '20%',
      ...
      validatorRules: {
        ...
        accountId: {
          rules: [{ required: true, message: 'Veuillez sélectionner le compte de recouvrement !' }],
        },
        discountMoney: {
  ...
  methods: {
    ...
    handleClickAdd() {
      ...
      if (organId) {
        ...
        this.$refs.debtBillList.title = 'Veuillez sélectionner le document de créance de vente'
      } else {
        this.$message.warning('Veuillez sélectionner le client !')
      }
    },
  },
}
