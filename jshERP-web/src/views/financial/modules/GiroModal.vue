        ...
        <a-row class="form-row" :gutter="24">
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Compte de paiement">
              <a-select placeholder="Veuillez sélectionner le compte de paiement" v-decorator="[ 'accountId', validatorRules.accountId ]"
                :dropdownMatchSelectWidth="false" showSearch optionFilterProp="children">
                <div slot="dropdownRender" slot-scope="menu">
                  <v-nodes :vnodes="menu" />
                  <a-divider style="margin: 4px 0;" />
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Montant réellement payé">
              <a-input placeholder="Veuillez saisir le montant réellement payé" v-decorator.trim="[ 'changeAmount', validatorRules.changeAmount ]" :readOnly="true"/>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
          </a-col>
    ...
    data () {
      return {
        ...
        accountTable: {
          ...
          dataSource: [],
          columns: [
            { title: 'Nom du compte',key: 'accountId',width: '20%', type: FormTypes.select, placeholder: 'Veuillez sélectionner ${title}', options: [],
        ...
        validatorRules:{
          ...
          accountId:{
            rules: [
              { required: true, message: 'Veuillez sélectionner le compte de paiement !' }
            ]
          },
          changeAmount:{
            rules: [
              { required: true, message: 'Veuillez saisir le montant réellement payé !' }
            ]
          }
        },
        url: {
