      ...
      <a-form :form="form">
        ...
        >
          <template #inOutItemAdd>
            ...
            <div v-if="quickBtn.inOutItem" class="dropdown-btn" @click="addInOutItem('out')">
              <a-icon type="plus" /> Ajouter un projet de recettes/dépenses
            </div>
            <div class="dropdown-btn" @mousedown="(e) => e.preventDefault()" @click="initInOutItem('out')">
              <a-icon type="reload" /> Actualiser la liste
            </div>
          </template>
        </j-editable-table>
        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Montant de dépense">
              <a-input
                placeholder="Veuillez saisir le montant de dépense"
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        accountId: {
          rules: [{ required: true, message: 'Veuillez sélectionner le compte de dépense !' }],
        },
        changeAmount: {
          rules: [{ required: true, message: 'Veuillez saisir le montant de dépense !' }],
        },
      },
      url: {
