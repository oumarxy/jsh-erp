      ...
      <a-card :style="cardStyle" :bordered="false">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            ...
            <template v-if="toggleSearchStatus">
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="Numéro de commande d'achat" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input
                      placeholder="Veuillez saisir le numéro de commande d'achat"
        ...
        <div class="table-operator" style="margin-top: 5px">
          <a-button v-if="btnEnableList.indexOf(1) > -1" @click="myHandleAdd" type="primary" icon="plus"
            >Ajouter</a-button
          >
          <a-button v-if="btnEnableList.indexOf(1) > -1" @click="myHandleAddWithOrgan" icon="link"
            >En attente de paiement({{ waitTotal }})</a-button
          >
        ...
        <div>
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '付款', prefixNo)">Voir</a>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: 'Fournisseur', dataIndex: 'organName', width: 140, ellipsis: true },
        ...
        { title: 'Total des paiements', dataIndex: 'totalPrice', width: 80 },
        { title: 'Montant de remise', dataIndex: 'discountMoney', width: 80 },
        { title: 'Paiement réel', dataIndex: 'changeAmount', width: 80 },
