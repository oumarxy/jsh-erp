    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="Unité de correspondance" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select placeholder="Veuillez sélectionner l'unité de correspondance" showSearch allow-clear optionFilterProp="children" v-model="queryParam.organId" @search="handleSearchOrgan">
                    <div slot="dropdownRender" slot-scope="menu">
                      <v-nodes :vnodes="menu" />
                      <a-divider style="margin: 4px 0;" />
                      <div class="dropdown-btn" @mousedown="e => e.preventDefault()" @click="initOrgan(0)"><a-icon type="reload" /> Actualiser la liste</div>
                    </div>
            ...
            <template v-if="toggleSearchStatus">
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="Compte de recette" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="Veuillez sélectionner le compte de recette" showSearch allow-clear optionFilterProp="children" v-model="queryParam.accountId">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="Projet de recette" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="Veuillez sélectionner le projet de recette" showSearch allow-clear optionFilterProp="children" v-model="queryParam.inOutItemId">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" title="Le bon de recette traite principalement les recettes autres que les recettes de vente, telles que les recettes de services de réparation, les recettes d'intérêts, les recettes d'ajustement comptable, etc." slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '收入', prefixNo)">Voir</a>
    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: 'Compte de recette', dataIndex: 'accountName',width:100, ellipsis:true},
          { title: 'Montant de recette', dataIndex: 'changeAmount',width:80},
