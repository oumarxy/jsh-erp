    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator" style="margin-top: 5px">
          ...
          <a-tooltip
            placement="left"
            title="Utilisé pour les retours de documents d'entrée d'achat. Le document de retour d'achat peut être converti depuis un document de sortie d'achat ou créé séparément."
            slot="action"
          >
        ...
        <div>
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '采购退货出库', prefixNo)">Voir</a>
