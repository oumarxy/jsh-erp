<template>
  ...
  >
    <template slot="footer">
      ...
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrintPro('其它出库')"
        >Impression en trois exemplaires - Nouvelle version</a-button
      >
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrint('其它出库')"
      ...
      <a-form :form="form">
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            ...
            >
              <a-input-search
                placeholder="Veuillez sélectionner le document en attente de sortie"
...
export default {
  ...
  methods: {
    ...
    onSearchLinkNumber() {
      ...
      this.$refs.waitBillList.title = 'Veuillez sélectionner la sortie de vente ou le retour d\'achat'
    },
