<template>
  ...
  >
    <template slot="footer">
      ...
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrintPro('销售退货入库')"
        >Impression en trois exemplaires - Nouvelle version</a-button
      >
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrint('销售退货入库')"
...
export default {
  ...
  methods: {
    ...
    onSearchLinkNumber() {
      ...
      this.$refs.linkBillList.title = 'Veuillez sélectionner la sortie de vente'
    },
    linkBillListOk(
