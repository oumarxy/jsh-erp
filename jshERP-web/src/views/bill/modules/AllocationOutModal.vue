<template>
  ...
  >
    <template slot="footer">
      ...
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrintPro('调拨出库')"
        >Impression en trois exemplaires - Nouvelle version</a-button
      >
      <a-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrint('调拨出库')"
