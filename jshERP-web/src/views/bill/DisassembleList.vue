    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" title="Utilisé pour diviser un produit en plusieurs produits. Le stock du produit divisé augmente, le stock des produits divisés diminue." slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '拆卸单', prefixNo)">Voir</a>
