      ...
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator" style="margin-top: 5px">
          ...
          <a-button
            ...
            >Convertir en retour de vente au détail</a-button
          >
          ...
          <a-tooltip
            placement="left"
            title="Utilisé pour la saisie de documents pour les non-membres et les membres, principalement pour les clients individuels, ne peut pas avoir de dettes."
            slot="action"
          >
        ...
        <div>
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '零售出库', prefixNo)">Voir</a>
  ...
  data() {
    return {
      ...
      defColumns: [
        ...
        { title: 'Type de paiement', dataIndex: 'payType', width: 80 },
        ...
        { title: 'Compte de recouvrement', dataIndex: 'accountName', width: 80 },
