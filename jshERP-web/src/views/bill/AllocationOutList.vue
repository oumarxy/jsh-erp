    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator" style="margin-top: 5px">
          ...
          <a-tooltip
            placement="left"
            title="Utilisé pour le transfert de produits entre deux entrepôts. Le document de transfert affectera le stock."
            slot="action"
          >
        ...
        <div>
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '调拨出库', prefixNo)">Voir</a>
