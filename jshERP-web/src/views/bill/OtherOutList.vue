      ...
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator" style="margin-top: 5px">
          ...
          <a-button v-if="inOutManageFlag && btnEnableList.indexOf(1) > -1" @click="handleWaitBill" icon="link"
            >En attente de sortie ({{ waitTotal }})</a-button
          >
          ...
          <a-tooltip
            placement="left"
            title="Peut être utilisé pour l'initialisation des stocks, la sortie de matériaux du module de gestion de production"
            slot="action"
          >
        ...
        <div>
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '其它出库', prefixNo)">Voir</a>
...
export default {
  ...
  methods: {
    ...
    handleWaitBill() {
      ...
      this.$refs.batchWaitBill.title = "Sélection en lot des sorties de vente ou retours d'achat"
    },
    waitModalFormClose() {
      this.loadData()
      this.initWaitBillCount('出库', '销售,采购退货', '1,3')
