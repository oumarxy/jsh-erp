      ...
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator" style="margin-top: 5px">
          ...
          <a-button
            ...
            >Convertir en retour d'achat</a-button
          >
          ...
          <a-tooltip
            placement="left"
            title="Le document d'entrée d'achat peut être converti depuis une commande d'achat ou créé séparément. La liste des entrepôts dans le document d'entrée d'achat n'affiche que les entrepôts auxquels l'utilisateur actuel a accès. Le document d'entrée d'achat peut utiliser le paiement multi-comptes. Après avoir coché les documents, vous pouvez effectuer des opérations par lots (suppression, audit, désaudit)"
            slot="action"
          >
        ...
        <div>
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '采购入库', prefixNo)">Voir</a>
            ...
            <template slot="customRenderDebt" slot-scope="value, record">
              <a-tooltip title="Avec document de paiement">
                <span style="color: green" v-if="value > 0 && record.hasFinancialFlag">{{ value }}</span>
              </a-tooltip>
              <a-tooltip title="Pas encore payé">
  ...
  data() {
    return {
      ...
      defColumns: [
        ...
        { title: 'Paiement actuel', dataIndex: 'changeAmount', width: 80 },
