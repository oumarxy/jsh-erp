<template>
  ...
  >
    <a-row :gutter="10" style="padding: 10px; margin: -10px">
            ...
            <a-row :gutter="24">
              <a-col :md="12" :sm="24">
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Numéro de série">
                  <a-input
                    ref="name"
                    placeholder="Veuillez saisir le numéro de série et appuyer sur Entrée"
              ...
              <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
                <a-col :md="12" :sm="24">
                  <a-button type="primary" @click="onSearch">Rechercher</a-button>
                  <a-button style="margin-left: 8px" type="primary" @click="checkAll">Tout sélectionner</a-button>
                  <a-button style="margin-left: 8px" @click="searchReset(1)">Réinitialiser</a-button>
                </a-col>
              </span>
            </a-row>
          </a-form>
      ...
      <a-col :md="8" :sm="24">
        <span style="font-size: 16px; font-weight: bold">Liste des numéros de série sélectionnés</span>
        <a-button style="margin-left: 8px" @click="clearAllSn">Effacer</a-button>
      </a-col>
    </a-row>
    <a-row :gutter="10" style="padding: 10px; margin: -10px">
      <a-col :md="16" :sm="24">
        ...
        >
          <span slot="action" slot-scope="text, record">
            <a @click="checkSn(record)">Sélectionner</a>
          </span>
        </a-table>
      </a-col>
      <a-col :md="8" :sm="24">
        ...
        >
          <span slot="action" slot-scope="text, record">
            <a @click="removeSn(record)">Retirer</a>
          </span>
        </a-table>
      </a-col>
    </a-row>
...
export default {
  ...
  data() {
    return {
      ...
      categoryTree: [],
      leftColumns: [
        { dataIndex: 'serialNumber', title: 'Numéro de série', width: 100, align: 'left' },
        { dataIndex: 'inBillNo', title: 'Numéro de bon de réception', width: 100, align: 'left' },
        { dataIndex: 'createTimeStr', title: 'Date de création', width: 100, align: 'left' },
        {
          dataIndex: 'action',
          title: 'Opération',
          align: 'center',
