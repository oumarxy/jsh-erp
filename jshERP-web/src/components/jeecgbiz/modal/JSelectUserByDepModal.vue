      ...
      <a-col :md="18" :sm="24">
        <a-card :bordered="false">
          ...
          <a-input-search
            ...
            @search="onSearch"
          ></a-input-search>
          <a-button @click="searchReset(1)" style="margin-left: 20px" icon="redo">Réinitialiser</a-button>
          <!--用户列表-->
          <a-table
            ref="table"
...
export default {
  ...
  data() {
    return {
      ...
      selectUserRows: [],
      selectUserIds: [],
      title: 'Sélectionner un utilisateur par département',
      ipagination: {
        current: 1,
        pageSize: 10,
        pageSizeOptions: ['10', '20', '30'],
        showTotal: (total, range) => {
          return range[0] + '-' + range[1] + ' sur ' + total + ' enregistrements'
        },
