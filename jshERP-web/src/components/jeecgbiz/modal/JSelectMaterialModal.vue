            ...
            <a-row :gutter="24">
              <a-col :md="6" :sm="8">
                <a-form-item label="Mot-clé" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-input
                    ref="material"
                    placeholder="Veuillez saisir le code-barres, le nom, le code mnémonique, etc."
                    v-model="queryParam.q"
                  ></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="8">
                <a-form-item label="Spécifications/Modèle" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-input
                    placeholder="Veuillez saisir les spécifications et le modèle"
                    v-model="queryParam.standardOrModel"
                  ></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="8">
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="Entrepôt">
                  <a-select
              ...
              <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
                <a-col :md="6" :sm="8">
                  <a-button type="primary" @click="loadMaterialData(1)">Rechercher</a-button>
                  <a-button style="margin-left: 8px" @click="searchReset(1)">Réinitialiser</a-button>
                  <a-tooltip title="Aucun résultat trouvé, décidez d'ajouter un produit !">
                    <a-button style="margin-left: 8px" @click="addMaterial">Ajouter</a-button>
                  </a-tooltip>
                  <a @click="handleToggleSearch" style="margin-left: 8px">
                    {{ toggleSearchStatus ? 'Réduire' : 'Développer' }}
...
export default {
  ...
  methods: {
    ...
    addMaterial() {
      ...
      this.$refs.materialModalForm.title = 'Ajouter un produit'
    },
