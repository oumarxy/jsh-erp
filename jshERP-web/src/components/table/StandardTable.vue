  ...
  <div class="standard-table">
    <div class="alert">
      <a-alert type="info" :show-icon="true">
        <div slot="message">
          Sélectionné&nbsp;<a style="font-weight: 600">{{ selectedRows.length }}</a
          >&nbsp;&nbsp;
          ...
          <a style="margin-left: 24px" @click="onClearSelected">Effacer</a>
        </div>
      </a-alert>
    </div>
    <a-table
...
export default {
  ...
  methods: {
    ...
    pager() {
      return {
        total: this.total,
        showTotal: (total) => `Total de ${total} enregistrements`,
