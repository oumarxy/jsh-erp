          ...
          <a-tab-pane :tab="msg1Title" key="1">
            <a-list>
              ...
              <div style="margin-top: 5px; text-align: center">
                <a-button @click="toMyAnnouncement()" type="dashed" block>Voir plus</a-button>
              </div>
            </a-list>
          </a-tab-pane>
        </a-tabs>
        ...
        getAction(this.url.getMsgByStatus, { status: '1' })
          .then((res) => {
            if (res && res.code === 200) {
              ...
              this.msg1Title = 'Notification(' + res.data.length + ')'
            }
          })
          .catch((error) => {
