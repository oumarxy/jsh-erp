    ...
    <a-drawer width="300" placement="right" :closable="false" @close="onClose" :visible="visible" :style="{}">
      <div class="setting-drawer-index-content">
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">Paramètres de style global</h3>

          <div class="setting-drawer-index-blockChecbox">
            <a-tooltip>
              <template slot="title"> Style de menu sombre </template>
            ...
            <a-tooltip>
              <template slot="title"> Style de menu clair </template>
        ...
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">Couleur du thème</h3>
          ...
          <div :style="{ marginTop: '24px' }">
            <a-list :split="false">
              <a-list-item>
                ...
                <a-list-item-meta>
                  <div slot="title">En-tête fixe</div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
                <a-switch
                ...
                <a-list-item-meta>
                  <div slot="title" :style="{ textDecoration: !fixedHeader ? 'line-through' : 'unset' }">
                    Masquer l'en-tête lors du défilement
                  </div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
        ...
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">Paramètres de langue</h3>
        ...
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">Autres paramètres</h3>
          <div>
            <a-list :split="false">
              <a-list-item>
                <a-switch slot="actions" size="small" :defaultChecked="colorWeak" @change="onColorWeak" />
                <a-list-item-meta>
                  <div slot="title">Mode daltonien</div>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </div>
...
export default {
  ...
  data() {
    return {
      visible: true,
      langSetTitle: 'Sélectionner une langue',
      currentLang: '',
      colorList,
    }
  },
