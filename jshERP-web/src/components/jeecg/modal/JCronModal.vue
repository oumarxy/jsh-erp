    ...
    <div class="card-container">
      <a-tabs type="card">
        <a-tab-pane key="1" type="card">
          <span slot="tab"><a-icon type="schedule" /> Seconde</span>
          <a-radio-group v-model="result.second.cronEvery">
            <a-row>
              <a-radio value="1">Chaque seconde</a-radio>
            </a-row>
            <a-row>
              <a-radio value="2"
                >Toutes les
            ...
            <a-row>
              <a-radio value="3">Secondes spécifiques (sélection multiple)</a-radio>
        ...
        <a-tab-pane key="2">
          <span slot="tab"><a-icon type="schedule" />Minute</span>
          <div class="tabBody">
            <a-radio-group v-model="result.minute.cronEvery">
              <a-row>
                <a-radio value="1">Chaque minute</a-radio>
              </a-row>
              <a-row>
                <a-radio value="2"
                  >Toutes les
              ...
              <a-row>
                <a-radio value="3">Minutes spécifiques (sélection multiple)</a-radio>
        ...
        <a-tab-pane key="3">
          <span slot="tab"><a-icon type="schedule" /> Heure</span>
          <div class="tabBody">
            <a-radio-group v-model="result.hour.cronEvery">
              <a-row>
                <a-radio value="1">Chaque heure</a-radio>
              </a-row>
              <a-row>
                <a-radio value="2"
                  >Toutes les
              ...
              <a-row>
                <a-radio class="long" value="3">Heures spécifiques (sélection multiple)</a-radio>
        ...
        <a-tab-pane key="4">
          <span slot="tab"><a-icon type="schedule" /> Jour</span>
          <div class="tabBody">
            <a-radio-group v-model="result.day.cronEvery">
              <a-row>
                <a-radio value="1">Chaque jour</a-radio>
              </a-row>
              <a-row>
                <a-radio value="2"
                  >Toutes les
              ...
              <a-row>
                <a-radio class="long" value="4">Jours de la semaine spécifiques (sélection multiple)</a-radio>
              ...
              <a-row>
                <a-radio class="long" value="5">Jours spécifiques (sélection multiple)</a-radio>
              ...
              <a-row>
                <a-radio value="6">Le dernier jour du mois</a-radio>
              </a-row>
              <a-row>
                <a-radio value="7">Le dernier jour ouvrable du mois</a-radio>
              </a-row>
              <a-row>
                <a-radio value="8"
                  >Le dernier
              ...
              <a-row>
                <a-radio value="10"
                  >Jour ouvrable le plus proche (lundi à vendredi) du
                  <a-input-number
                    size="small"
        ...
        <a-tab-pane key="5">
          <span slot="tab"><a-icon type="schedule" /> Mois</span>
          <div class="tabBody">
            <a-radio-group v-model="result.month.cronEvery">
              <a-row>
                <a-radio value="1">Chaque mois</a-radio>
              </a-row>
              <a-row>
                <a-radio value="2"
                  >Tous les
              ...
              <a-row>
                <a-radio class="long" value="3">Mois spécifiques (sélection multiple)</a-radio>
                <a-select
                  style="width: 354px"
                  size="small"
                  filterable
        ...
        <a-tab-pane key="6">
          <span slot="tab"><a-icon type="schedule" /> Année</span>
          <div class="tabBody">
            <a-radio-group v-model="result.year.cronEvery">
              <a-row>
                <a-radio value="1">Chaque année</a-radio>
              </a-row>
              <a-row>
                <a-radio value="2"
                  >Toutes les
              ...
              <a-row>
                <a-radio class="long" value="3">Années spécifiques (sélection multiple)</a-radio>
                <a-select
                  style="width: 354px"
                  size="small"
                  filterable
