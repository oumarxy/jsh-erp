<template>
  <a-modal title="Importer EXCEL" :width="600" :visible="visible" :confirmLoading="uploading" @cancel="handleClose">
    <a-upload
      name="file"
      :multiple="true"
      accept=".xls,.xlsx"
    ...
    <template slot="footer">
      <a-button @click="handleClose">Fermer</a-button>
      <a-button type="primary" @click="handleImport" :disabled="fileList.length === 0" :loading="uploading">
        {{ uploading ? 'Téléchargement en cours...' : 'Commencer le téléchargement' }}
      </a-button>
    </template>
  </a-modal>
</template>
