...
export function welcome() {
  const arr = [
    ...
    'Voulez-vous jouer à DOTA?',
    'Je pense que vous êtes peut-être fatigué',
  ]
...
/**
 * Filtrer les propriétés vides dans un objet
 * @param obj
 * @returns {*}
 */
...
// Générer la route de la page d'accueil
...
// Générer des routes imbriquées (routes enfants)
